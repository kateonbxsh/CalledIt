...
const CAM_OFF = 0.22;
// Restored conservative logarithmic distance curve: slow growth and strong taper.
const KM_PER_WORLD_UNIT = 0.001, DISTANCE_MULT_K = 0.52, DISTANCE_MULT_SCALE = 500, STAR_MULT = 0.14;
...
export function PlaneGame({
  ...
  useEffect(() => {
    ...
    const curMult = () => {
      const distanceBonus = DISTANCE_MULT_K * Math.log1p(Math.max(0, plane.wx - launchX) / DISTANCE_MULT_SCALE);
